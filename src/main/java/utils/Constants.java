...
public class Constants {
    ...
    public final static int EXAMINE_THREAD_NUMBER = 70;
    public final static int FETCHER_THREAD_NUMBER = 70;
    public final static int PARSER_THREAD_NUMBER = 8;
    public final static int HBASE_THREAD_NUMBER = 10;
    public final static int ELASTIC_THREAD_NUMBER = 10;
    public final static int KAFKA_THREAD_NUMBER = 10;
